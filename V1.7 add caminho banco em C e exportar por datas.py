...
layout_menu = [
    [sg.Text("Busca pela Etiqueta"), sg.Input(size=(24), key="buscar_etiqueta"), sg.Button("Buscar"), sg.Button('Importar Excel'), sg.Button('Exportar por Data')],
...
def janela_create():
    layout_create = [
        [sg.Text("Etiqueta Copo"), sg.Input(size=(24), key="qrcode_copo")],
        [sg.Text("Etiqueta Placa"), sg.Input(size=(24), key="qrcode_placa")],
            ...
            try:
                ...
                for index, row in df.iterrows():
                    ...
                    cursor.execute('''
                        ...
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                    ''', (qrcode_copo, qrcode_placa, datetime.now().strftime("%d-%m-%Y %H:%M:%S"), None, None, None, None, None, None, None))
