    ...
    if evento == "Novo Registro":
        ...
        while True:
            ...
            if evento_novo == "Criar":
                ...
                if not valores_novo['etiqueta_copo'] or not valores_novo['etiqueta_placa']:
                ...
                cursor.execute('''
                    ...
                    WHERE etiqueta_copo = ? OR etiqueta_placa = ?
                ''', (valores_novo['etiqueta_copo'], valores_novo['etiqueta_placa']))
