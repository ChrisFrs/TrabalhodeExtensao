...
def export_to_csv():
    ...
    with open('registros_exportados.csv', mode='w', newline='', encoding='utf-8') as file:
        ...
        writer.writerow(['ID', 'QR Code Copo', 'QR Code Placa', 'Hora de Entrada', 'ID do Testador', 'Nome do Debugger', 'Hora do Debug', 'ID da Reparadora', 'Hora do Reparo', 'Observação', 'Componentes'])
        # Escrevendo os dados
